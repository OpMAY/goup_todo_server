            ...
            <div class="page-title-box">
              <div class="page-title-right">
                <ol class="breadcrumb m-0">
                  ...
                  <li class="breadcrumb-item"><a href="javascript: void(0);">QnAs</a></li>
                  <li class="breadcrumb-item active">QnA Detail</li>
                </ol>
              </div>
              <h4 class="page-title">QnA Detail</h4>
            </div>
          </div>
        </div>
        <!-- end page title -->
               ...
               <!-- end col -->
                  <div class="col-lg-10">
                    <div class="ps-xl-3 mt-3 mt-xl-0">
                      <a href="#" class="text-primary">No ${qna.no}</a>
                      <br><br>
                      <div class="col-md-10">
                        <div class="mb-3">
                          <label for="title" class="form-label">제목</label>
                          <input class="form-control" type="text" placeholder= "${qna.title}" id="title" />
                        </div>
                        <div class="mb-10">
                        ...
                        <div class="mb-10">
                          <div class="form-check">
                            <label class="form-check-label" for="customCheck2">해당 QnA 미사용</label>
