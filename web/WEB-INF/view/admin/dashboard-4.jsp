                            ...
                            <div class="card-body">
                                <div class="card-widgets">
                                    ...
                                    <a data-bs-toggle="collapse" href="#cardCollpase1" role="button"
                                       aria-expanded="false" aria-controls="cardCollpase1"><i class="mdi mdi-minus"></i></a>
                        ...
                        <div class="widget-rounded-circle card">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <div class="avatar-lg">
                                            <img src="/resources/admin/assets/images/users/user-5.jpg"
                                                 class="img-fluid rounded-circle" alt="user-img">
                                        </div>
                                    </div>
                                    <div class="col">
                        ...
                        <div class="widget-rounded-circle card bg-blue">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <div class="avatar-lg">
                                            <img src="/resources/admin/assets/images/users/user-6.jpg"
                                                 class="img-fluid rounded-circle img-thumbnail" alt="user-img">
                                        </div>
                                    </div>
                                    <div class="col">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered table-nowrap table-borderless mb-0">
                                            ...
                                            <tr>
                                                    ...
                                                    <div class="avatar-group">
                                                        ...
                                                        <a href="javascript: void(0);" class="avatar-group-item"
                                                           ...
                                                           title="Michael Zenaty">
                                                            <img src="/resources/admin/assets/images/users/user-2.jpg"
                                                                 class="rounded-circle avatar-xs" alt="friend">
                                                        </a>
                                                ...
                                                <td><span
                                                        class="badge bg-soft-info text-info p-1">Work in Progress</span>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="badge bg-soft-warning text-warning p-1">Pending</span>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="avatar-group">
                                                        ...
                                                        <a href="javascript: void(0);" class="avatar-group-item"
                                                           data-bs-toggle="tooltip" data-bs-placement="top"
                                                           title="Username">
                                                            <img src="/resources/admin/assets/images/users/user-7.jpg"
                                                                 class="rounded-circle avatar-xs" alt="friend">
                                                        </a>
                                                    </div>
                                                </td>
                                                <td><span
                                                        class="badge bg-soft-success text-success p-1">Completed</span>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="avatar-group">
                                                        <a href="javascript: void(0);" class="avatar-group-item"
                                                           data-bs-toggle="tooltip" data-bs-placement="top"
                                                           title="Mat Helme">
                                                            <img src="/resources/admin/assets/images/users/user-9.jpg"
                                                                 class="rounded-circle avatar-xs" alt="friend">
                                                        </a>
                                                        ...
                                                        <a href="javascript: void(0);" class="avatar-group-item"
                                                           data-bs-toggle="tooltip" data-bs-placement="top"
                                                           title="Michael Zenaty">
                                                            <img src="/resources/admin/assets/images/users/user-10.jpg"
                                                                 class="rounded-circle avatar-xs" alt="friend">
                                                        </a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="avatar-group">
                                                        ...
                                                        <a href="javascript: void(0);" class="avatar-group-item"
                                                           data-bs-toggle="tooltip" data-bs-placement="top"
                                                           title="James Anderson">
                                                            <img src="/resources/admin/assets/images/users/user-8.jpg"
                                                                 class="rounded-circle avatar-xs" alt="friend">
                                                        </a>
                                                ...
                                                <td><span class="badge bg-soft-dark text-dark p-1">Coming Soon</span>
                                                </td>
                                                <td>Karel Auberjo</td>
                                            </tr>
...
<!-- Plugins js -->
<script src="/resources/admin/assets/libs/morris.js06/morris.min.js"></script>
<script src="/resources/admin/assets/libs/raphael/raphael.min.js"></script>

<!-- Dashboard init-->
<script src="/resources/admin/assets/js/pages/dashboard-4.init.js"></script>
